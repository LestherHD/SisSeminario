...
const usuarioSchema = new mongoose.Schema(
  {
    ...
    verificacionEmailExpires: { type: Date, select: false },
    verificacionEmailAttempts: { type: Number, default: 0, select: false },
    verificacionEmailSolicitadoEn: { type: Date, select: false },
